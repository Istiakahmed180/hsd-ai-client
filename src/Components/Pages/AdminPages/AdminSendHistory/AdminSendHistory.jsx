  ...
  const handleDeleteData = async (id) => {
    try {
      const deletingData = await axios.delete(
        `http://ec2-13-229-77-43.ap-southeast-1.compute.amazonaws.com/api/send/delete-send-history/${id}`
      );
    ...
    const fetchData = async () => {
      try {
        ...
        const getAllSendingHistory = await axios.get(
          "http://ec2-13-229-77-43.ap-southeast-1.compute.amazonaws.com/api/send/all-send-history"
        );
